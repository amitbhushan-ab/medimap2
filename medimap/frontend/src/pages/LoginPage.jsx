...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem('medimap_user', JSON.stringify({ email: form.email, name: form.email.split('@')[0] }));
      navigate('/');
    }, 1500);
  };
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button className="text-xs text-[#2E7DFF] hover:underline">
          ...
          >
            {loading ? (
              <span className="flex items-center justify-center gap-2">
                ...
                {lang === 'hi' ? 'लॉगिन हो रहे हैं...' : 'Signing in...'}
              </span>
            ) : (
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link to="/signup" className="text-[#2E7DFF] font-semibold hover:underline">
